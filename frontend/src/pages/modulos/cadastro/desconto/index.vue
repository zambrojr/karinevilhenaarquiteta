...
<section>
    <page-title nome="Descontos" subTitulo="Dascontos a serem aplicados no total do Orçamento"></page-title>
                    ...
                    <section>
                        <div class="row" ref="container">
                            <box-padrao isOpen>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <b-button variant="outline-secondary" @click="novaPessoa">Cadastrar Desconto</b-button>
                                    </div>
                                </div>                                
                            </box-padrao>
                        </div>
